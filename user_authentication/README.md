...
**Usage:** Instantiate the `UserAuth` class to manage user authentication operations. Call the methods like `register_user`, `login`, `logout`, and `is_authenticated` as needed.
...
---
*Auto-generated documentation - Last updated: 2025-07-18 00:44:48*
