...
2. **auth.py**
   ...
   - Use the functions provided in `auth.py` to handle user authentication tasks such as login, logout, and session management.
...
---
*Auto-generated documentation - Last updated: 2025-07-18 08:03:26*
